...
public class ModelElevatorTop extends ModelBase
{
	//fields
	ModelRenderer bottom_platform;
	ModelRenderer bottom_bars;
	
	public ModelElevatorTop()
	{
		textureWidth = 128;
		textureHeight = 64;
		
		bottom_platform = new ModelRenderer(this, 0, 19);
		bottom_platform.addBox(0F, 0F, 0F, 16, 2, 16);
		bottom_platform.setRotationPoint(-8F, 8F, -8F);
		...
		bottom_bars.addBox(0F, 0F, 0F, 16, 14, 16);
		bottom_bars.setRotationPoint(-8F, 10F, -8F);
