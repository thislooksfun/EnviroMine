...
import enviromine.blocks.models.ModelElevatorBottom;
...
{
	ModelElevatorBottom model;
	
	public TileEntityElevatorBottomRenderer()
	{
		this.model = new ModelElevatorBottom();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f)
	{
		...
		//Use in 1.6.2  this
		ResourceLocation textures = (new ResourceLocation("enviromine:textures/blocks/elevator_model.png"));
