...
public class EnviroPhysicsExplosion
{
	...
	public Explosion dummyExplode;

    /** A list of ChunkPositions of blocks affected by this explosion */
    public List affectedBlockPositions = new ArrayList();
    private Map field_77288_k = new HashMap();

	public EnviroPhysicsExplosion(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9)
	{
        ...
        this.dummyExplode = new Explosion(par1World, par2Entity, par3, par5, par7, par9);
	}

	public static EnviroPhysicsExplosion newExplosion(World world, Entity entity, double x, double y, double z, float size, boolean hasFire, boolean hasSmoke, DamageSource damageSource)
	{
		EnviroPhysicsExplosion explosion = new EnviroPhysicsExplosion(world, entity, x, y, z, size);
        explosion.isFlaming = hasFire;
        explosion.isSmoking = hasSmoke;
        explosion.damageType = damageSource;
        explosion.dummyExplode.isFlaming = hasFire;
        explosion.dummyExplode.isSmoking = hasSmoke;
                    ...
                    if (i == 0 || i == this.field_77289_h - 1 || j == 0 || j == this.field_77289_h - 1 || k == 0 || k == this.field_77289_h - 1)
                    {
                        ...
                        for (float f2 = 0.3F; f1 > 0.0F; f1 -= f2 * 0.75F)
                        {
                            ...
                            if (k1 > 0)
                            {
                                ...
                                float f3 = this.exploder != null ? this.exploder.getBlockExplosionResistance(dummyExplode, this.worldObj, l, i1, j1, block) : block.getExplosionResistance(this.exploder, worldObj, l, i1, j1, explosionX, explosionY, explosionZ);
                                f1 -= (f3 + 0.3F) * f2;
                            }

                            if (f1 > 0.0F && (this.exploder == null || this.exploder.shouldExplodeBlock(dummyExplode, this.worldObj, l, i1, j1, k1, f1)))
                            {
        ...
        for (int k2 = 0; k2 < list.size(); ++k2)
        {
            ...
            if (d7 <= 1.0D)
            {
                ...
                if (d8 != 0.0D)
                {
                    ...
                    entity.attackEntityFrom(damageType, (float)((int)((d10 * d10 + d10) / 2.0D * 8.0D * (double)this.explosionSize + 1.0D)));
	...
	private void doExplosionB(boolean b)
	{
